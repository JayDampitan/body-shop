...
const Hero = () => {
  return (
    <div className="w-full h-auto ">
      ...
      <div className="border-b border-yellow-600 pb-10 flex my-10 mx-auto flex-col max-w-lg lg:max-w-[30%] items-center justify-center text-center">
        ...
        <button className="border uppercase border-yellow-600 text-yellow-600 py-1 px-3 rounded-full
         mt-6 hover:bg-yellow-600 hover:text-white duration-300">
...
{/* ------- first hero section ----image with the girl-----------------*/}
      ...
      <div className="text-center flex flex-col items-center justify-center lg:flex-row mt-20">
        <div className="relative mb-10">
          <div className="absolute w-full h-full bg-yellow-600 -translate-x-6 -translate-y-6"></div>
          <Image
            className="relative w-80 sm:w-96 lg:w-[800px] bg-yellow-600 hover:-translate-x-3 hover:-translate-y-3 duration-300"
      ...
      <div className="text-center flex flex-col items-center justify-center lg:flex-row-reverse my-20 mb-">
        <div className="relative mb-10">
          <div className="absolute w-full h-full bg-yellow-600 -translate-x-6 -translate-y-6"></div>
          <Image
            className="relative z-10 w-80 sm:w-96  lg:w-[800px] bg-yellow-600 hover:-translate-x-3 hover:-translate-y-3 duration-300"
            src={smoothie}
          />
        </div>
