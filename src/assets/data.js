...
export const MEMBER__PLAN = [
  {
    title: "single day pass [1 unit punch card]",
    contract: "single day contract does not renew",
    length: "    single day",
    fee: " $0.00",
    price: "$5.00",
  },
  {
    title: "monthly auto pay single",
    contract: "1 month - renews every expiration",
    length: "1 month",
    fee: " $25.00",
    price: "$29.00",
  },
  {
    title: "year paid in full - 1 year",
    contract: "1 year - does not renew",
    length: "1 year",
    fee: " $60.96",
    price: "$299.99",
  },
